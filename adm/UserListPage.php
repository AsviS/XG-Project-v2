...
if ($Observation != 1) die();
	...
	while ($u = mysql_fetch_assoc($query))
	{
		...
		$Bloc['adm_ul_data_actio']  		= ($u['id'] != $user['id'] && $user['authlevel'] == 3) ? "<a href=\"UserListPage.php?cmd=dele&user=".$u['id']."\" border=\"0\" onclick=\"return confirm('".$lang['ul_sure_you_want_dlte']."  $u[username]?');\"><img border=\"0\" src=\"../styles/images/false.png\"></a>" : "-";
